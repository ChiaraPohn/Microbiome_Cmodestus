...
otus_all <- otu_table(ps_rdrdp)
sum_reads <- rowSums(otus_all)
sum_reads


#get my OTUs as relative abundances instead:
otu_rel_abundance <- as(otu_table(ps.V2), "matrix")
...
new_otu_names <- c("NODE_A13_length_3436_cov_154.678773_W39" = "Broome luteo-like virus 1", 
                   ...
                   "NODE_A28_length_2975_cov_68.363699_LS_NIC5" = "Sewage-associated circular DNA virus-16", 
...
meta <- as.data.frame(sample_data(ps_rdrdp))
